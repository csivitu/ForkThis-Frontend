...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-max  flex flex-col p-4 justify-between ">
      <div className=" w-full h-max bg-slate-500 flex rounded">
        <div id="profile" className="flex justify-between items-center w-1/4">
          <img
      ...
      <div id="Nav-items" className="flex ">
        ...
        <div className="w-full">
          <Tabs.Root>
            <Tabs.List>
              <div className="flex">
                <TabsTrigger value="tab1" onClick={profileHandler}>
                  Profile
                </TabsTrigger>
                <TabsTrigger value="tab2">Challenges</TabsTrigger>
